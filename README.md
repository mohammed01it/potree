...
Fork / rebranded distribution of Potree 1.8.2, presented as "PointVista 3D" for customized deployments. Core engine and APIs remain under the original Potree license and namespace. All references to Potree in code correspond to the upstream project.
